...
const MCP_URL =
  process.env.NEXT_PUBLIC_SUPERMEMORY_MCP_URL ||
  'https://mcp.supermemory.ai/guyugQ3xRxBWjmW7izcQx/sse'
const API_KEY =
  process.env.NEXT_PUBLIC_SUPERMEMORY_API_KEY ||
  'sm_mTx77GLefaYFCKTRmJcKRh_JRTcGtPbVPmfcDrNmTBSmXKYuBbQGajHxxIfWQvWfiTGIUPBsWBZdQRZMugYPyPC'
