...
const AdminEmailSystem: React.FC = () => {
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      if (emailRecipients.length === 0) {
        throw new Error('No email recipients found. Recipients must have email addresses and email notifications enabled.');
      }
      ...
      const htmlContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: linear-gradient(135deg, #2953A6, #6bb7e3); color: white; padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
            ...
            <p>Message from Rob Stevens, HOA Administrator</p>
          </div>
      ...
      const { data: emailResult, error: emailError } = await supabase.functions.invoke('send-email', {
        body: {
          ...
          html: htmlContent,
          from: 'Rob Stevens <rob@ursllc.com>'
        }
      });
  ...
  const getRecipientSummary = () => {
    switch (recipientMode) {
      ...
      case 'building':
        return selectedBuilding ? `All residents in Building ${selectedBuilding} with email` : 'Select a building';
      case 'individual':
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm">Send emails from rob@ursllc.com</p>
          </div>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-6">
          <h3 className="text-lg font-semibold text-white mb-4">Select Email Recipients</h3>
        ...
        <div className="glass-card p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white/80 text-sm">
                Rob Stevens &lt;rob@ursllc.com&gt;
              </div>
            </div>
