...
const EmailTestComponent: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="glass-card mx-auto max-w-2xl p-6"
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Email Address */}
        <div>
          <label className="mb-2 block text-sm font-medium text-white">Test Email Address</label>
          <input
            type="email"
            value={testEmail}
            onChange={(e) => setTestEmail(e.target.value)}
            required
            className="w-full rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-white placeholder-white/50 transition-all duration-300 focus:border-blue-400/50 focus:outline-none focus:ring-2 focus:ring-blue-400/50"
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full resize-none rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-white placeholder-white/50 transition-all duration-300 focus:border-blue-400/50 focus:outline-none focus:ring-2 focus:ring-blue-400/50"
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="rounded-xl bg-white/10 px-4 py-3 font-medium text-white transition-colors hover:bg-white/20"
          >
            View Logs
          </button>
        </div>
            ...
            <div className="flex-1">
              ...
              {result.details && (
                <details className="mt-2">
                  <summary className="cursor-pointer text-sm opacity-80">View Details</summary>
      ...
      <div className="mt-6 rounded-lg border border-blue-500/20 bg-blue-500/10 p-4">
        <h3 className="mb-2 font-medium text-blue-300">Testing Instructions</h3>
