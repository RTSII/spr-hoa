...
const OwnerInbox: React.FC<OwnerInboxProps> = ({ user_id, isModal = false, onClose }) => {
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="mb-1 flex items-center justify-between">
                        ...
                        <span
                          className={`rounded border px-2 py-1 text-xs ${getPriorityColor(message.priority)}`}
                        >
                          {message.priority}
                        </span>
                      </div>
            ...
            <div className="p-6">
              <div className="mb-6 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  <span
                    className={`rounded border px-2 py-1 text-xs ${getPriorityColor(selectedMessage.priority)}`}
                  >
  ...
  return (
    <motion.div
      ...
      className="glass-card h-[600px] overflow-hidden p-0"
    >
      <InboxContent />
    </motion.div>
  )
